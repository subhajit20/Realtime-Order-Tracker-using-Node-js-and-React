...
function Card({ prodimage,title, prodtitle,placeorder,btnname,option,viewOrder }) {
  return (
        ...
        <div className="buy_button grid grid-cols-1 gap-y-5 w-full col-span-2 py-2 px-1">
          {
            ...
            btnname !== undefined ? <button className="bg-orange-600 text-white rounded-md py-1 text-xl font-medium" onClick={placeorder}>{btnname}</button> : ""
          }
